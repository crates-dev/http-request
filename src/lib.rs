...
pub(crate) use http_type::{
    ...
    HOST, HTTP_BR, HTTP_BR_BYTES, HTTP_DOUBLE_BR_BYTES, HttpStatus, HttpUrlComponents, HttpVersion,
    LOCATION, Methods, Protocol, QUERY_SYMBOL, RequestBody, RequestBodyString, RequestError,
    RequestHeaders, ResponseHeaders, ResponseStatusCode, SPACE_U8, TAB_U8, USER_AGENT, ZERO_STR,
};
